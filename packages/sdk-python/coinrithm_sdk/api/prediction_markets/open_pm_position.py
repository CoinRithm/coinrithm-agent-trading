...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Error | OpenPmPositionResponse422 | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[Error | OpenPmPositionResponse422]:
    return Response(
...
) -> Response[Error | OpenPmPositionResponse422]:
...
def sync(
    *,
...
) -> Error | OpenPmPositionResponse422 | None:
    r""" Open a mock prediction-market position
    ...
    Returns:
        Error | OpenPmPositionResponse422
     """
