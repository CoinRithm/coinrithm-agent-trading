...
T = TypeVar("T", bound="ResolveSymbolResponse200AlternativesItem")



@_attrs_define
class ResolveSymbolResponse200AlternativesItem:
    """ 
        Attributes:
            coin_id (str | Unset):
            slug (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        resolve_symbol_response_200_alternatives_item = cls(
            coin_id=coin_id,
            slug=slug,
            symbol=symbol,
            name=name,
        ...
        resolve_symbol_response_200_alternatives_item.additional_properties = d
        return resolve_symbol_response_200_alternatives_item
