...
if TYPE_CHECKING:
  ...
  from ..models.get_market_context_response_200_related_markets_item import GetMarketContextResponse200RelatedMarketsItem
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _related_markets is not UNSET:
            ...
            for related_markets_item_data in _related_markets:
                related_markets_item = GetMarketContextResponse200RelatedMarketsItem.from_dict(related_markets_item_data)
