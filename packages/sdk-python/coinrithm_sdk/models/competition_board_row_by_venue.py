...
T = TypeVar("T", bound="CompetitionBoardRowByVenue")



@_attrs_define
class CompetitionBoardRowByVenue:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        competition_board_row_by_venue = cls(
            spot=spot,
            futures=futures,
            pm=pm,
        )
        ...
        competition_board_row_by_venue.additional_properties = d
        return competition_board_row_by_venue
