...
T = TypeVar("T", bound="GetPmPositionsResponse200")


@_attrs_define
class GetPmPositionsResponse200:
    """
    Attributes:
        positions (list[PmPosition] | Unset):
        updated_since (datetime.datetime | None | Unset):
        as_of (datetime.datetime | Unset):
    """

    positions: list[PmPosition] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _positions is not UNSET:
            ...
            for positions_item_data in _positions:
                positions_item = PmPosition.from_dict(positions_item_data)
        ...
        get_pm_positions_response_200 = cls(
            positions=positions,
            updated_since=updated_since,
            as_of=as_of,
        )

        get_pm_positions_response_200.additional_properties = d
        return get_pm_positions_response_200
