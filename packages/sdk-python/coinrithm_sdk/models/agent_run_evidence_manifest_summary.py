...
if TYPE_CHECKING:
  ...
  from ..models.agent_run_evidence_manifest_summary_related_entities_item import AgentRunEvidenceManifestSummaryRelatedEntitiesItem
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_first_event_at(data: object) -> datetime.datetime | None | Unset:
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                first_event_at_type_0 = isoparse(data)
        ...
        if _related_entities is not UNSET:
            ...
            for related_entities_item_data in _related_entities:
                related_entities_item = AgentRunEvidenceManifestSummaryRelatedEntitiesItem.from_dict(related_entities_item_data)
