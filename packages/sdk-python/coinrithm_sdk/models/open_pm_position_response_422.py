...
T = TypeVar("T", bound="OpenPmPositionResponse422")



@_attrs_define
class OpenPmPositionResponse422:
    """ 
        Attributes:
            error (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        open_pm_position_response_422 = cls(
            error=error,
            block_reasons=block_reasons,
        )


        open_pm_position_response_422.additional_properties = d
        return open_pm_position_response_422
