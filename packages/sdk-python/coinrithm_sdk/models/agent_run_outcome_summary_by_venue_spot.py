...
T = TypeVar("T", bound="AgentRunOutcomeSummaryByVenueSpot")


@_attrs_define
class AgentRunOutcomeSummaryByVenueSpot:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        agent_run_outcome_summary_by_venue_spot = cls(
            realized_pnl_musd=realized_pnl_musd,
            matched_outcome_count=matched_outcome_count,
        )

        agent_run_outcome_summary_by_venue_spot.additional_properties = d
        return agent_run_outcome_summary_by_venue_spot
