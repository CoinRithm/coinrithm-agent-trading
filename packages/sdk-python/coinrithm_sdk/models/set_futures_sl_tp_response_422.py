...
T = TypeVar("T", bound="SetFuturesSlTpResponse422")


@_attrs_define
class SetFuturesSlTpResponse422:
    """
    Attributes:
        error (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        set_futures_sl_tp_response_422 = cls(
            error=error,
            block_reasons=block_reasons,
        )

        set_futures_sl_tp_response_422.additional_properties = d
        return set_futures_sl_tp_response_422
