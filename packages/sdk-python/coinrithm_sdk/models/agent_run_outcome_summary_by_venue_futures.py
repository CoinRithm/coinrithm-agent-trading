...
T = TypeVar("T", bound="AgentRunOutcomeSummaryByVenueFutures")



@_attrs_define
class AgentRunOutcomeSummaryByVenueFutures:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        agent_run_outcome_summary_by_venue_futures = cls(
            realized_pnl_musd=realized_pnl_musd,
            matched_outcome_count=matched_outcome_count,
        )


        agent_run_outcome_summary_by_venue_futures.additional_properties = d
        return agent_run_outcome_summary_by_venue_futures
