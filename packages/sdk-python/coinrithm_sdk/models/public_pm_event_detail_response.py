...
if TYPE_CHECKING:
    ...
    from ..models.public_pm_event_detail_response_cross_source_matches_item import (
    ...
    from ..models.public_pm_event_detail_response_volume_history_item import (
...
class PublicPmEventDetailResponse:
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.public_pm_event_detail_response_resolution_type_0 import (
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.public_pm_event_detail_response_related_news_item import (
        ...
        if _cross_source_matches is not UNSET:
            ...
            for cross_source_matches_item_data in _cross_source_matches:
                cross_source_matches_item = PublicPmEventDetailResponseCrossSourceMatchesItem.from_dict(
                    cross_source_matches_item_data
                )
