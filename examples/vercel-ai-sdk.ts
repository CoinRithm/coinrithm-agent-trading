...
// pay an adverse spread + size-based slippage. Futures quote funding is an
// estimate from the latest venue rate and may change before settlement;
// covered futures charges use recorded settled venue history.
