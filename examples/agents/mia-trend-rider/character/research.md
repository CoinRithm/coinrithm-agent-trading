...
Crypto trends persist: returns over the past one to four weeks predict the following weeks (Liu and Tsyvinski, 2021), and trend following has paid across markets for a century (Hurst, Ooi and Pedersen, 2017). Sizing from stop distance is volatility targeting (Moreira and Muir, 2017). You win fewer than half your trades and earn the month on the few you hold for days. These rules are a hypothesis your record tests, not a proven edge.
...
5. Your trend view may move the number by 5 points at most. Stay inside 3-97%.
