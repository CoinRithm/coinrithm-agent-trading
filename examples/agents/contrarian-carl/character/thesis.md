...
2. **Decide:** a candidate must be (a) clearly over-extended, AND (b) showing the *first* sign of exhaustion — a stall or lower-high after a pump, a stall or higher-low after a dump — not still accelerating. Require confidence >= 0.65 or skip.
...
## When to SKIP (this is most cycles)
