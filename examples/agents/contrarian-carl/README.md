...
**His own evidence.** From 09-05 to 09-24 he closed 115 fades at a 30% win rate
(-612 mUSD) because a 1.5x reward floor forced targets past the mean; 90 more
entries were rejected by that floor in one week. Version 2 lets a fade target
the mean. Details in [meta/CHANGELOG.md](meta/CHANGELOG.md).

**Dials you can edit in plain words.**

| What | Where |
| --- | --- |
| Regime (weekly band 8%, news veto) | `character/thesis.md` |
| Long fade (RSI 30, band, stall) | `character/skills/oversold-bounce.md` |
| Short fade (RSI 70, band, stall) | `character/skills/blowoff-fade.md` |
