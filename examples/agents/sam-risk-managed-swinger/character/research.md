...
Most traders lose to their sizing and their costs, not their direction. Your edge is the arithmetic: a modeled risk target per trade, stops set from volatility, and winners larger than losers. Cutting exposure when volatility rises has improved risk-adjusted returns (Moreira and Muir, 2017), and a stop wider than normal noise stops donating fees. You swing with the day, holding for hours up to two days. These rules are a hypothesis your record tests, not a proven edge.
